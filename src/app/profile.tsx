            ...
            <View className="px-4">
                ...
                <ScrollView className="h-full">
                    <View className="items-center mt-8">
                        <Avatar/>
                        <Text className="text-title text-2xl font-bold mt-4">{user.name}</Text>
                        <Text className="text-textSecondary mt-1">{user.title}</Text>
                    </View>

                        {/* HABILIDADES */}
                        <View className="mt-8">
                            <Text className="text-title text-xl font-semibold mb-3">Suas Habilidades</Text>
                            ...
                            <TouchableOpacity className="px-4 py-2 bg-card rounded-full border border-border flex-row items-center gap-2">
                                <FontAwesome5 name="plus" size={12} color="#6E6E73" />
                        ...
                        <View className="mt-10">
                            <Text className="text-title text-xl font-semibold mb-3"> Experiências Profissionais</Text>
                            ...
                            <View key={i} className="mb-4">
                                ...
                                >
                                    <View className="flex-row justify-between items-center">
                                        <View>
                                            <Text className="text-title font-medium">{exp.cargo}</Text>
